...
export const db = factory({
  ...
  postDetail: {
    ...
    views: nullable(() => faker.number.int({ min: 1, max: 1000 })),
    ...
    commentCount: nullable(() => faker.number.int({ min: 1, max: 1000 })),
  },
  userProfile: {
    id: primaryKey(faker.string.uuid),
    ...
    stats: nullable(() => JSON.stringify(({ postCount: faker.number.int({ min: 1, max: 1000 }), commentCount: faker.number.int({ min: 1, max: 1000 }), totalViews: faker.number.int({ min: 1, max: 1000 }) }))),
