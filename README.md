...
Schemock supports one-time production seeding for default data (super admin users, default products, etc.) with secret validation and a kill switch to prevent re-seeding.
